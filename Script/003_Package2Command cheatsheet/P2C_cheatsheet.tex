...
\newtcblisting{mybox}[2][]{colback=black!10!white,colframe=blue!75!black,fonttitle=\bfseries,title=#2,#1,breakable,bicolor,colbacklower=white,interior style={left color=yellow!70,right color=green!70},%哪个[]里有数，证明哪个是必填参数
listing options={
